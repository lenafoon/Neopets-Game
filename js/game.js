...
class Doughnutfruit {
  ...
  createImageElement() {
    ...
    document.getElementById("inGame-container").appendChild(imgElement);
    return imgElement;
  }
...
const doughnutfruitsData = [
  ...
  {name: 'Tropical-Doughnutfruit' , imageSrc: 'Neopets-Doughnutfruits/tropical_donutfruit.gif', pointValue: 2, isGood: true},
